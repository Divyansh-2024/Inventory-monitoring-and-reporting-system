...
class ProductDAOImplTest {
    ...
    void testAddAndGetAllProducts() throws SQLException {
        Product p = new Product(999, "Test Product", "TestCategory", 10, 299.99);
    ...
    void testUpdateProduct() throws SQLException {
        Product p = new Product(1000, "Update Product", "TestCategory", 5, 150.0);
        productDAO.addProduct(p);
    ...
    void testDeleteProduct() throws SQLException {
        Product p = new Product(1001, "Delete Product", "TestCategory", 1, 50.0);
        productDAO.addProduct(p);

        assertTrue(productDAO.deleteProduct(1001));
        assertFalse(productDAO.getAllProducts().stream().anyMatch(prod -> prod.getId() == 1001));
    }

    @Test
    void testGetProductsByPriceRange() throws SQLException {
        Product p1 = new Product(2001, "Price1", "CategoryA", 10, 120.0);
        Product p2 = new Product(2002, "Price2", "CategoryA", 5, 350.0);
        Product p3 = new Product(2003, "Price3", "CategoryB", 7, 600.0);
